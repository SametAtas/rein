...
def build_parser() -> argparse.ArgumentParser:
    ...
    p_review.add_argument("--stdin", action="store_true", help="Read source code from stdin and review it as one file (content mode).")
    p_review.add_argument("--filename", help="Virtual path for --stdin content, used in findings and path-based rules (default: stdin.py).")
